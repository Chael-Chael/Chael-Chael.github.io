...
export default function Profile({ author, social, features, researchInterests }: ProfileProps) {
    ...
    useEffect(() => {
        ...
        const userHasLiked = storage?.getItem('jiale-website-user-liked');
    ...
    const handleLike = () => {
        ...
        if (newLikedState) {
            storage?.setItem('jiale-website-user-liked', 'true');
            setShowThanks(true);
            setTimeout(() => setShowThanks(false), 2000);
        } else {
            storage?.removeItem('jiale-website-user-liked');
            setShowThanks(false);
        }
    };
    ...
    return (
        ...
        >
            ...
            {researchInterests && researchInterests.length > 0 && (
                <div className="bg-white dark:bg-neutral-100 rounded-2xl p-4 mb-6 hover:shadow-lg transition-all duration-200 hover:scale-[1.02] border border-neutral-100 dark:border-neutral-200">
