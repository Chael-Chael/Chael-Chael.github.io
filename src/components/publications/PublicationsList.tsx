                                    ...
                                    <div className="flex flex-wrap gap-2 mt-auto">
                                        {pub.url && (
                                            <a
                                                ...
                                                className="inline-flex items-center px-3 py-1 rounded-md text-xs font-medium bg-neutral-100 dark:bg-neutral-800/50 text-neutral-700 dark:text-neutral-100 hover:bg-accent hover:text-white dark:hover:bg-accent transition-colors border border-transparent dark:border-neutral-700"
                                            >
