...
export function ThemeToggle() {
  ...
  if (!mounted) {
    return (
      <div className="flex items-center justify-center w-10 h-10 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-background dark:bg-neutral-100">
