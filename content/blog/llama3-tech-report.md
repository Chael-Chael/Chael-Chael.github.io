这篇 Llama 3 报告精读，最开始其实是因为参加考核才决定仔细研究的。但在读的时候，我发现里面有很多值得深挖的技术细节，于是顺带着补充了不少前置背景知识，最后整理出来了这一份。

为了让大家读得更顺手，我没死板地按照原文顺序写，而是建议先从 Abstract & Results 看起。大家先对模型的实际表现有一个整体的感知，然后再去详细分析后面的那些技术原理。
